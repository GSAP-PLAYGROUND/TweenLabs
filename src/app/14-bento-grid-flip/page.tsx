...
/* 
  ...
  This wraps the core GSAP 3D perspective 
  tilt and spotlight hover animations.
  =========================================
*/
...
export default function BentoGridPage() {
  ...
  return (
    <div className="relative min-h-screen bg-[#f0eadf] text-[#2a2a2a] flex flex-col items-center justify-between p-6 md:p-12 selection:bg-[#f1b333] selection:text-black overflow-x-hidden font-sans">
      {/* Background Dot Grid */}
      <div
