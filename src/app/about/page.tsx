...
export default function AboutPage() {
  return (
    <div className="relative min-h-screen bg-[#f0eadf] text-[#2a2a2a] flex flex-col items-center pt-24 pb-16 selection:bg-wtf-yellow selection:text-black">
      ...
      <main className="w-full max-w-5xl px-4 md:px-8 lg:px-12 xl:px-16 py-8 md:py-12 lg:py-16 flex flex-col gap-12 lg:gap-16 z-10">
        {/* Title and Intro */}
        <div className="flex flex-col gap-4 border-b-3 border-[#2a2a2a] pb-6 mt-4">
          <div className="inline-flex self-start items-center gap-2 bg-wtf-orange border-2 border-[#2a2a2a] px-3 py-1 rounded-full text-[10px] lg:text-[11px] font-mono font-bold text-white uppercase tracking-widest shadow-[2px_2px_0px_#2a2a2a] tilt-right">
            <span>Engineering & E-E-A-T Standards</span>
          </div>
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-serif font-black uppercase tracking-tight text-[#2a2a2a]">
            About TweenLabs
          </h1>
          <p className="text-sm md:text-base lg:text-lg font-sans font-medium text-[#4a4a4a] leading-relaxed max-w-3xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-10">
          {/* Card 1: Experience */}
          <div className="brutalist-card bg-white p-6 md:p-8 lg:p-10 flex flex-col gap-4 lg:gap-5 relative">
            <div className="absolute top-4 right-4 font-mono font-bold text-xs text-wtf-orange">
              [ E-01 ]
            </div>
            <h2 className="text-xl lg:text-2xl font-serif font-black uppercase tracking-tight text-[#2a2a2a] border-b-2 border-[#2a2a2a]/20 pb-2">
              🛠️ Experience
            </h2>
            <p className="text-sm lg:text-base font-sans text-zinc-700 leading-relaxed">
