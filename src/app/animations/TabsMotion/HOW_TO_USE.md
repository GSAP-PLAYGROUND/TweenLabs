...
Animated tab navigation with a sliding indicator pill. When you switch tabs, the indicator slides smoothly to the new tab and content crossfades with directional animation (left/right).
...
```bash
npx tweenlabs@latest add TabsMotion
```
...
3. In your project, create a new file: `src/components/TabsMotion.tsx`
...
import TabsMotion from "@/components/TabsMotion";
...
|------|------|---------|-------------|
| `tabs` | `Array` | Required | Array of tab items (label, content component). |
