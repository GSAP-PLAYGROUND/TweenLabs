...
export default function KineticTypographyPage() {
  ...
  return (
    ...
    >
      ...
      >
        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-serif font-black tracking-tight flex flex-wrap justify-center gap-x-4 gap-y-2 w-full text-center">
