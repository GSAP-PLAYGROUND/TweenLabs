      ...
      <div className="relative z-10 w-full max-w-5xl mx-auto px-4 sm:px-6 md:px-8 lg:px-12 pt-12 sm:pt-16 lg:pt-20 pb-24">
        ...
        <div className="mb-10">
          <div className="flex flex-wrap gap-2 mb-5">
            <span className="font-mono text-[9px] font-black uppercase tracking-widest px-2.5 py-1 rounded-full border-2 border-[#2a2a2a] bg-white text-[#2a2a2a]">
              TweenLabs
            </span>
            <span className="font-mono text-[9px] font-black uppercase tracking-widest px-2.5 py-1 rounded-full border-2 border-[#0c9367] bg-[#0c9367] text-white">
              MIT License
            </span>
          </div>
          ...
          <p className="font-sans text-[13px] sm:text-[14px] lg:text-base text-zinc-500 leading-relaxed max-w-[52ch]">
            Pick any animation from the gallery. Install it in seconds via the
            CLI, or copy-paste it manually — no build step, no config.
          </p>
        </div>
        ...
        {method === "cli" && (
          <div>
            <p className="font-sans text-[13px] text-zinc-500 leading-relaxed mb-6 max-w-[52ch]">
              The TweenLabs CLI installs any component directly into your
              project with a single command. It downloads the file and all
            ...
            <div className="mb-7">
              ...
              <p className="font-sans text-[12.5px] text-zinc-500 mb-3 ml-[34px]">
                Replace <Code>ComponentName</Code> with the exact name from the
                gallery (e.g. <Code>KineticText</Code>, <Code>FlipCards</Code>,{" "}
                <Code>MorphingText</Code>).
              </p>
              ...
              <p className="flex items-start gap-2 text-[11.5px] font-sans text-zinc-500 leading-relaxed mt-2 ml-[34px]">
                ...
                No global install needed — the runner fetches the latest version
                every time.
              </p>
            </div>
            ...
            <div className="mb-7">
              ...
              <p className="font-sans text-[12.5px] text-zinc-500 ml-[34px] leading-relaxed">
                The CLI places the component file in your project and installs{" "}
                <Code>gsap</Code> and <Code>@gsap/react</Code> if they
                aren&apos;t already present. Import and use it immediately.
              </p>
            </div>
            ...
            <div className="ml-[34px] mb-7 p-3.5 border-2 border-[#2a2a2a] bg-amber-50/70 text-amber-900 rounded-lg shadow-[2.5px_2.5px_0px_#2a2a2a] flex gap-2.5 max-w-lg">
              ...
              <div>
                <div className="font-mono font-black text-[10px] uppercase tracking-wider mb-1">
                  CLI Notice
                </div>
                <p className="font-sans text-[11.5px] leading-relaxed">
                  Run in your project&apos;s root directory. The CLI creates the
                  file under{" "}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-6 mb-7 items-start">
              {/* Examples column */}
              <div>
                <p className="font-mono font-black text-[9px] uppercase tracking-widest text-zinc-400 mb-3">
                  Examples
                </p>
                <div className="space-y-2.5">
                  {[
                    ...
                    <div
                      key={name}
                      className="border-2 border-[#2a2a2a] rounded-lg overflow-hidden bg-[#121212] shadow-[2.5px_2.5px_0px_#2a2a2a]"
                    >
                      <div className="bg-[#181818] border-b border-white/10 px-3 py-2 flex items-center justify-between">
                        <div className="flex items-center gap-2">
                          <span className="font-serif font-black text-[12px] text-white">
                            {name}
                          </span>
                ...
                <div className="bg-white border-2 border-[#2a2a2a] rounded-xl p-5 shadow-[3px_3px_0px_#2a2a2a] space-y-3">
                  {[
                    [
                      "Node.js 18+",
                      <>
                        <span className="text-zinc-500">check with </span>
                        <Code>node --version</Code>
                      </>,
                    ],
                    [
                      "Next.js App Router",
                      "components use the App Router file convention",
                    ],
                    ...
                    [
                      "pnpm (recommended)",
                      <>
                        <span className="text-zinc-500">install via </span>
                    ...
                    <div
                      key={i}
                      className="flex gap-3 text-[12.5px] font-sans leading-relaxed border-b border-dashed border-[#2a2a2a]/10 pb-3 last:border-0 last:pb-0"
                    >
                      <span className="font-mono font-black text-[#0c9367] shrink-0">
                        ✓
                      </span>
                      <span>
        ...
        {method === "manual" && (
          <div>
            <p className="font-sans text-[13px] text-zinc-500 leading-relaxed mb-6 max-w-[52ch]">
              No CLI, no magic. Browse the gallery, open any animation&apos;s{" "}
              <strong className="text-[#2a2a2a]">Code</strong> tab, and paste it
            ...
            <div className="mb-7">
              ...
              <div className="ml-[34px] space-y-2.5 font-sans text-[12.5px] text-zinc-600 leading-relaxed">
                ...
                <p>
                  2. Click the <strong className="text-[#2a2a2a]">Code</strong>{" "}
                  tab at the top of the preview.
                </p>
                <p>
                  3. Copy the entire file and paste it into a new file in your
                  project, for example:
                </p>
                <PlainTerminal label="path">
                  {"src/app/animations/KineticText/page.tsx"}
                </PlainTerminal>
                <p className="flex items-start gap-2 text-zinc-500">
                  <span className="text-[#f1b333] shrink-0">→</span>
                  Each component is 100% self-contained — no imports from other
                  TweenLabs files.
                </p>
              </div>
            </div>
            ...
            <div className="mb-7">
              ...
              <div className="ml-[34px]">
                <p className="font-sans text-[12.5px] text-zinc-500 mb-3">
                  GSAP requires a browser environment. Every animation file must
            ...
            <div className="mb-7">
              ...
              <p className="font-sans text-[12.5px] text-zinc-500 ml-[34px] leading-relaxed">
                Navigate to the route in your browser. The animation runs
                immediately — no extra config needed.
              </p>
            </div>
            ...
            <div className="bg-white border-2 border-[#2a2a2a] rounded-xl p-5 shadow-[3px_3px_0px_#2a2a2a] space-y-3 max-w-lg">
              {[
                [
                  "Always use useGSAP()",
                  "Never raw useEffect — it won't clean up properly on unmount.",
                ],
                [
                  "Pass a scope ref",
                  "useGSAP(() => { ... }, { scope: containerRef }) scopes selectors to your component.",
                ],
                [
                  "Register plugins at file top",
                  "gsap.registerPlugin(ScrollTrigger) goes outside the component function.",
                ],
                [
                  "Use inline Tailwind",
                  "No custom CSS classes — use exact hex values like bg-[#e55b3c] directly.",
                ],
              ].map(([title, desc]) => (
                <div
                  key={title as string}
                  className="flex gap-3 text-[12px] font-sans leading-relaxed border-b border-dashed border-[#2a2a2a]/10 pb-3 last:border-0 last:pb-0"
                >
                  <span className="font-mono font-black text-[#e55b3c] shrink-0 mt-0.5">
                    →
                  </span>
                  <span>
                    <strong className="text-[#2a2a2a]">
          ...
          <div className="bg-white border-2 border-[#2a2a2a] rounded-xl overflow-hidden shadow-[3px_3px_0px_#2a2a2a]">
            ...
            <ul className="p-4 space-y-0">
              {[
                ...
                <li
                  key={i}
                  className="flex items-start gap-2.5 py-2 border-b border-dashed border-[#2a2a2a]/10 last:border-0"
                >
                  ...
                  <span className="text-[12px] font-sans text-zinc-600 leading-relaxed">
                    {item}
                  </span>
                </li>
              ))}
              ...
              {[
                [
                  ...
                  <>
                    ...
                    <Code>&quot;use client&quot;</Code> at the top — GSAP
                ...
                [
                  ...
                  <>
                    Call <Code>gsap.registerPlugin(ScrollTrigger)</Code>{" "}
                    <em>outside</em> any component or hook.
                  </>,
                ],
                [
                  "Port 3000 already in use?",
                  <>
                    Run <Code>pnpm dev -- -p 3001</Code> to use a different
                    port.
                  </>,
                ],
                [
                  ...
                  <>
                    Wrap animated elements in a <Code>useEffect</Code>-guarded
                    mount check or use <Code>suppressHydrationWarning</Code>.
                  </>,
                ],
              ].map(([title, desc], i) => (
                <div
                  key={i}
                  className="border-b border-dashed border-[#2a2a2a]/10 pb-3 last:border-0 last:pb-0"
                >
                  <p className="font-bold text-[#2a2a2a] text-[12px] mb-1">
                    {title as string}
                  </p>
                  <p className="text-[11.5px] font-sans text-zinc-500 leading-relaxed">
                    {desc as React.ReactNode}
                  </p>
                </div>
              ))}
        ...
        <div className="bg-white border-2 border-[#2a2a2a] rounded-xl overflow-hidden shadow-[3px_3px_0px_#2a2a2a] mb-4">
          ...
          <div className="p-4 sm:p-5 lg:p-6 grid grid-cols-1 sm:grid-cols-2 gap-5 lg:gap-6">
            <div>
              <p className="font-mono font-black text-[9px] uppercase tracking-widest text-zinc-400 mb-2">
                Basic Tween
              </p>
      ...
      start: "top 80%",
          ...
          <div className="flex items-start gap-2 px-5 py-3 border-t border-[#2a2a2a]/10 bg-[#eff5ff]/60 text-[11.5px] font-sans text-zinc-500">
            ...
            <span>
              ...
              <a
                ...
                className="text-[#3b82f6] font-bold underline underline-offset-2"
              >
                gsap.com/docs/v3/
              </a>
              {" · "}
              ...
              <a
                href="https://gsap.com/docs/v3/Packages/@gsap/react/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-[#3b82f6] font-bold underline underline-offset-2"
              >
                gsap.com/docs/v3/Packages/@gsap/react
              </a>
            </span>
          </div>
        </div>
        ...
        <div className="mt-8 rounded-2xl border-2 border-[#2a2a2a] bg-[#2a2a2a] p-6 sm:p-8 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-5 shadow-[4px_4px_0px_#0c9367] overflow-hidden relative">
          ...
          <div className="relative">
            <p className="font-mono font-black text-[9px] uppercase tracking-widest text-[#f1b333] mb-1">
              ready?
            </p>
            <p className="font-serif font-black text-[1.4rem] lg:text-[1.6rem] text-white leading-tight">
          ...
          <div className="relative flex gap-3 flex-wrap">
            <a
              href="/components"
              className="font-mono text-[11px] font-black text-[#2a2a2a] bg-white border-2 border-white rounded-xl px-5 py-2.5 hover:bg-[#0c9367] hover:border-[#0c9367] hover:text-white transition-all duration-150"
            >
              🎨 Components
            </a>
            <a
              href="/contribution"
              className="font-mono text-[11px] font-black text-white border-2 border-white/30 rounded-xl px-5 py-2.5 hover:border-white transition-all duration-150"
            >
              🛠 Contribute
            </a>
          </div>
