...
export const metadata: Metadata = {
	title: "GSAP vs Framer Motion: Which Animation Library Should You Use in 2025? | TweenLabs",
	description:
...
const comparisons = [
	{
		...
		framer: "Built on React's render cycle. Good for simple animations but can cause re-renders with complex orchestrations. Spring physics are computed per-frame.",
		verdict: "GSAP",
		detail: "GSAP is faster for complex animations. Framer Motion is fine for simple UI transitions.",
	},
	{
		...
		framer: "useScroll hook + useTransform provides basic scroll-linked animations. No built-in pinning, snapping, or complex scrubbing. Often paired with Intersection Observer for triggers.",
		verdict: "GSAP",
		detail: "ScrollTrigger is leagues ahead. If you need scroll animations, GSAP is the clear choice.",
	},
	{
		category: "API Design",
		...
		framer: "Declarative API with JSX props. <motion.div animate={{x: 100}} />. More React-idiomatic. Easier learning curve for React developers.",
		verdict: "Framer Motion",
		detail: "Framer Motion's declarative API is more intuitive for React devs. GSAP requires more setup but rewards with more control.",
	},
	{
		...
		framer: "orchestrate with staggerChildren and delayChildren in variants. No true timeline — you define sequences through parent-child variant propagation.",
		verdict: "GSAP",
		detail: "GSAP's timeline is unmatched for complex, multi-step animation sequences.",
	},
	{
		category: "Bundle Size",
		gsap: "~26KB (core) + ~13KB (ScrollTrigger). Tree-shakeable. Plugins load separately.",
		framer: "~32KB for the full package. Includes layout animations, gestures, and AnimatePresence.",
		verdict: "Tie",
		detail: "Similar bundle sizes. Both are reasonable for modern web projects.",
	},
	{
		...
		framer: 'Works in client components with motion components. Requires "use client" directive. AnimatePresence works with route changes.',
		verdict: "Tie",
		detail: "Both work well with Next.js App Router. Framer Motion has slightly better exit animation support.",
	},
	{
		...
		framer: "Basic SVG animation via pathLength. No built-in SVG morphing. 3D transforms supported but without the depth of GSAP's plugin ecosystem.",
		verdict: "GSAP",
		detail: "GSAP's SVG and 3D plugin ecosystem is significantly more powerful.",
	},
];
