...
const animations = [
  ...
  },
  {
    ...
    bgColor: "bg-wtf-purple",
    textColor: "text-white",
    description: "Numeric counter loader opening into full clip-path fanning image grid layouts.",
    tiltClass: "tilt-right-lg",
  },
  {
    id: "19",
    name: "Presentation Spotlight",
    route: "/19-morph-element",
    bgColor: "bg-wtf-blue",
    textColor: "text-white",
    description: "Custom radial masking light beam spotlight following cursor movement.",
    tiltClass: "tilt-left-lg",
  },
  {
    id: "20",
    name: "SVG String Network",
    route: "/20-string-line",
    bgColor: "bg-wtf-yellow",
    textColor: "text-black",
  ...
  {
    id: "21",
    name: "SVG Scroll Drawing Line",
    route: "/21-svg-line2",
    bgColor: "bg-wtf-orange",
    textColor: "text-white",
    description: "Dual horizontal scroll drawing lines triggered by viewport scroll scrubbing.",
    tiltClass: "tilt-left",
  },
  {
    id: "22",
    name: "Logo Shapes Fusion",
    route: "/22-shapes",
    bgColor: "bg-wtf-green",
    textColor: "text-white",
    description: "Preloader shapes morphing, merging into a central logo, and exploding into grid assets.",
    tiltClass: "tilt-right",
  },
];
