...
export default function Header() {
  ...
  return (
    <header
      ref={headerRef}
      className="fixed top-0 left-0 w-full z-50 bg-[#fafaf9] border-b-3 border-[#2a2a2a]"
    >
      <div className="w-full px-4 md:px-8 lg:px-12 xl:px-16 h-14 md:h-16 flex items-center justify-between">
        ...
        >
          <span
            className={`block w-5 h-[2.5px] bg-[#2a2a2a] rounded-full transition-all duration-300 origin-center ${mobileMenuOpen ? "rotate-45 translate-y-[7.5px]" : ""}`}
          />
          <span
            className={`block w-5 h-[2.5px] bg-[#2a2a2a] rounded-full transition-all duration-300 ${mobileMenuOpen ? "opacity-0 scale-0" : ""}`}
          />
          <span
            className={`block w-5 h-[2.5px] bg-[#2a2a2a] rounded-full transition-all duration-300 origin-center ${mobileMenuOpen ? "-rotate-45 -translate-y-[7.5px]" : ""}`}
          />
